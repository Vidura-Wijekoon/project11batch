...
driver = webdriver.Chrome(executable_path='D:/Internships/Forsk_batch11_ViduraWijekoon/Codes/chromedriver.exe')
...
df.to_csv(r'D:/Internships/Forsk_batch11_ViduraWijekoon/Csv_datasets/reviews.csv',index=True)
...
cursor.execute("SELECT * FROM etsytable")
